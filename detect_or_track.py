    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                cv2.putText(im0, "Total de Mamoes: " + str(int(identities[0])), (20, 200), cv2.FONT_HERSHEY_PLAIN, 5, (0,0,0),9)
                cv2.putText(im0, "Mamoes nesse momento: " + str(len(identities)), (20, 300), cv2.FONT_HERSHEY_PLAIN, 5, (0,0,0),9)
